...
- 统一总论：`00-编程语言理论统一总论.md`
- 统一语义/语法：`02-语义与语法统一理论.md`
- 相关实现：`04-编译统一理论.md`、`03-类型统一理论.md`

## 术语表与符号

- 终结符/非终结符：Σ/V；产生式：A→α；起始符号：S
- 推导：⇒, ⇒*；FIRST/FOLLOW 集：句法分析常用集合
- 语义函数：⟦·⟧；操作转移：→/⇓；Hoare 三元组：{P} C {Q}
...
- G=(V,Σ,P,S)：文法四元组（非终结符、终结符、产生式、起始符）
- AST：抽象语法树
- ⇒/⇒*：一步/多步推导
- ⟨e,σ⟩ → ⟨e',σ'⟩：小步操作语义
- ⟦e⟧：指称语义映射
- Env/Store：环境/存储
- Token/Lexer/Parser：词法单元/词法分析器/语法分析器

## 2025 对齐

- **国际 Wiki**：
  - [Wikipedia: 语法和语义](https://en.wikipedia.org/wiki/语法和语义)
  - [nLab: 语法和语义](https://ncatlab.org/nlab/show/语法和语义)
  - [Stanford Encyclopedia: 语法和语义](https://plato.stanford.edu/entries/语法和语义/)

- **名校课程**：
  - [MIT: 语法和语义](https://ocw.mit.edu/courses/)
  - [Stanford: 语法和语义](https://web.stanford.edu/class/)
  - [CMU: 语法和语义](https://www.cs.cmu.edu/~语法和语义/)
