...
- **国际 Wiki**：
  - [Wikipedia: 并发模型](https://en.wikipedia.org/wiki/并发模型)
  - [nLab: 并发模型](https://ncatlab.org/nlab/show/并发模型)
  - [Stanford Encyclopedia: 并发模型](https://plato.stanford.edu/entries/并发模型/)

- **名校课程**：
  - [MIT: 并发模型](https://ocw.mit.edu/courses/)
  - [Stanford: 并发模型](https://web.stanford.edu/class/)
  - [CMU: 并发模型](https://www.cs.cmu.edu/~并发模型/)
