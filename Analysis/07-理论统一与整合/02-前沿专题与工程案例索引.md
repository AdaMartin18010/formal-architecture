...
> 交叉引用：
>
> - [安全架构理论](../07-分布式与微服务/04-软件架构理论体系/09-安全架构理论.md)
...
- **名校课程**：
  ...
  - [Stanford CS 244: Advanced Computer Systems](https://web.stanford.edu/class/cs244/)（系统案例）
...
- **前沿技术**：
  - [GitHub](https://github.com/)（代码案例库）
  - [Stack Overflow](https://stackoverflow.com/)（工程实践问答）
  - [Dev.to](https://dev.to/)（开发社区）
