...
- **国际 Wiki**：
  ...
  - [Wikipedia: Network protocol](https://en.wikipedia.org/wiki/Communication_protocol)
  - [Wikipedia: OSI model](https://en.wikipedia.org/wiki/OSI_model)
  - [Wikipedia: TCP/IP](https://en.wikipedia.org/wiki/Internet_protocol_suite)

- **名校课程**：
  - [MIT 6.033: Computer Systems Engineering](https://web.mit.edu/6.033/www/)（网络系统）
  - [Stanford CS 144: Introduction to Computer Networking](https://web.stanford.edu/class/cs144/)（计算机网络）
  - [CMU 15-441: Computer Networks](https://www.cs.cmu.edu/~prs/15-441-F09/)（计算机网络）

- **代表性论文**：
  - [End-to-End Arguments in System Design](https://web.mit.edu/Saltzer/www/publications/endtoend/endtoend.pdf) (Saltzer et al., 1984)
  - [TCP/IP Illustrated](https://www.pearson.com/us/higher-education/program/Stevens-TCP-IP-Illustrated-Volume-1-The-Protocols-2nd-Edition/PGM33482.html) (Stevens, 2011)
  - [QUIC: A UDP-Based Multiplexed and Secure Transport](https://www.rfc-editor.org/rfc/rfc9000) (RFC 9000, 2021)

- **前沿技术**：
  - [gRPC](https://grpc.io/)（高性能RPC框架）
  - [HTTP/3](https://httpwg.org/specs/rfc9114.html)（基于QUIC的HTTP）
  - [WebSocket](https://websockets.spec.whatwg.org/)（WebSocket协议）
  - [ZeroMQ](https://zeromq.org/)（消息传递库）
