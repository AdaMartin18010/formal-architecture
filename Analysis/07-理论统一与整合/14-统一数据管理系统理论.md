...
- **国际 Wiki**：
  ...
  - [Wikipedia: Database management system](https://en.wikipedia.org/wiki/Database_management_system)
...
- **名校课程**：
  ...
  - [MIT 6.830: Database Systems](https://ocw.mit.edu/courses/6-830-database-systems-fall-2010/)（数据库系统）
  - [Stanford CS 145: Introduction to Databases](https://web.stanford.edu/class/cs145/)（数据库导论）

- **代表性论文**：
  - [The Relational Model of Data for Large Shared Data Banks](https://dl.acm.org/doi/10.1145/362384.362685) (Codd, 1970)
...
- **前沿技术**：
  ...
  - [Apache Cassandra](https://cassandra.apache.org/)（分布式数据库）
