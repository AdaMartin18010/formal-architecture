...
- **国际 Wiki**：
  ...
  - [Wikipedia: Distributed consensus](https://en.wikipedia.org/wiki/Consensus_(computer_science))
...
- **名校课程**：
  ...
  - [Stanford CS 244: Advanced Computer Systems](https://web.stanford.edu/class/cs244/)（分布式共识）

- **代表性论文**：
  - [The Part-Time Parliament](https://lamport.azurewebsites.net/pubs/lamport-paxos.pdf) (Lamport, 1998)
...
- **前沿技术**：
  - [etcd](https://etcd.io/)（分布式键值存储，使用Raft）
  - [Consul](https://www.consul.io/)（服务发现，使用Raft）
  - [ZooKeeper](https://zookeeper.apache.org/)（分布式协调，使用ZAB）
  - [Raft Consensus](https://raft.github.io/)（Raft算法实现）
