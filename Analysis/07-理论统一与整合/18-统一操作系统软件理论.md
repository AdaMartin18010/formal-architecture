...
- **名校课程**：
  - [MIT 6.828: Operating System Engineering](https://pdos.csail.mit.edu/6.828/)（操作系统工程）
  - [Stanford CS 140: Operating Systems](https://web.stanford.edu/class/cs140/)（操作系统）
  - [CMU 15-213: Introduction to Computer Systems](https://www.cs.cmu.edu/~213/)（计算机系统）

- **代表性论文**：
  - [The UNIX Time-Sharing System](https://dsf.berkeley.edu/cs262/unix.pdf) (Ritchie & Thompson, 1974)
  - [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/) (Arpaci-Dusseau & Arpaci-Dusseau, 2018)
  - [The Design and Implementation of the FreeBSD Operating System](https://www.freebsd.org/doc/en_US.ISO8859-1/books/design-44bsd/) (McKusick et al., 2004)

- **前沿技术**：
  - [Linux Kernel](https://www.kernel.org/)（Linux内核）
  - [FreeBSD](https://www.freebsd.org/)（Unix操作系统）
