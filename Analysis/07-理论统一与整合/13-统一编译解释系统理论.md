...
- **名校课程**：
  ...
  - [Stanford CS 143: Compilers](https://web.stanford.edu/class/cs143/)（编译器）
...
- **代表性论文**：
  ...
  - [Modern Compiler Implementation in C](https://www.cs.princeton.edu/~appel/modern/c/) (Appel, 2004)
  - [Crafting Interpreters](https://craftinginterpreters.com/) (Nystrom, 2021)

- **前沿技术**：
  - [LLVM](https://llvm.org/)（编译器基础设施）
  - [GCC](https://gcc.gnu.org/)（GNU编译器集合）
  - [Rust Compiler](https://rustc-dev-guide.rust-lang.org/)（Rust编译器）
  - [GraalVM](https://www.graalvm.org/)（多语言虚拟机）
