...
- **国际 Wiki**：
  ...
  - [Wikipedia: Fog computing](https://en.wikipedia.org/wiki/Fog_computing)
  - [Wikipedia: Mobile edge computing](https://en.wikipedia.org/wiki/Mobile_edge_computing)

- **名校课程**：
  - [MIT 6.824: Distributed Systems](https://pdos.csail.mit.edu/6.824/)（分布式系统与边缘计算）
  - [CMU 15-445: Database Systems](https://15445.courses.cs.cmu.edu/)（分布式数据）
  - [Stanford CS 244: Advanced Computer Systems](https://web.stanford.edu/class/cs244/)（边缘系统）

- **代表性论文**：
  - [The Case for VM-Based Cloudlets in Mobile Computing](https://www.cs.cmu.edu/~satya/docdir/pradeep-mobisys2009.pdf) (Satyanarayanan et al., 2009)
  - [Edge Computing: Vision and Challenges](https://ieeexplore.ieee.org/document/7488250) (Shi et al., 2016)
  - [Fog Computing and Its Role in the Internet of Things](https://dl.acm.org/doi/10.1145/2342509.2342513) (Bonomi et al., 2012)

- **前沿技术**：
  - [Kubernetes Edge](https://kubernetes.io/docs/concepts/architecture/edge/)（Kubernetes边缘计算）
  - [K3s](https://k3s.io/)（轻量级Kubernetes）
  - [AWS IoT Greengrass](https://aws.amazon.com/greengrass/)（AWS边缘计算）
  - [Azure IoT Edge](https://azure.microsoft.com/en-us/products/iot-edge/)（Azure边缘计算）
