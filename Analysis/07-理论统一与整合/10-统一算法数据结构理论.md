...
- **名校课程**：
  - [MIT 6.006: Introduction to Algorithms](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-fall-2011/)（算法基础）
  - [CMU 15-122: Principles of Imperative Computation](https://www.cs.cmu.edu/~15122/)（数据结构）
  - [Stanford CS 161: Design and Analysis of Algorithms](https://web.stanford.edu/class/cs161/)（算法分析）

- **代表性论文**：
  - [Introduction to Algorithms](https://mitpress.mit.edu/9780262046305/introduction-to-algorithms/) (Cormen et al., 2022)
  - [The Art of Computer Programming](https://www-cs-faculty.stanford.edu/~knuth/taocp.html) (Knuth, 1968-)
  - [Data Structures and Algorithms](https://www.pearson.com/us/higher-education/program/Weiss-Data-Structures-and-Algorithm-Analysis-in-C-4th-Edition/PGM33482.html) (Weiss, 2011)

- **前沿技术**：
  - [LeetCode](https://leetcode.com/)（算法练习平台）
  - [Rosetta Code](https://rosettacode.org/)（算法实现集合）
  - [Algorithm Visualizer](https://algorithm-visualizer.org/)（算法可视化）
  - [Big-O Cheat Sheet](https://www.bigocheatsheet.com/)（复杂度参考）
