...
- **国际 Wiki**：
  - [Wikipedia: 应用框架](https://en.wikipedia.org/wiki/应用框架)
  - [nLab: 应用框架](https://ncatlab.org/nlab/show/应用框架)
  - [Stanford Encyclopedia: 应用框架](https://plato.stanford.edu/entries/应用框架/)

- **名校课程**：
  - [MIT: 应用框架](https://ocw.mit.edu/courses/)
  - [Stanford: 应用框架](https://web.stanford.edu/class/)
  - [CMU: 应用框架](https://www.cs.cmu.edu/~应用框架/)
