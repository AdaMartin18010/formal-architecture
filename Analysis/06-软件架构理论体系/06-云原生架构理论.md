...
- [06-软件架构理论体系-云原生架构理论](#06-软件架构理论体系-云原生架构理论)
  ...
  - [形式化定义](#形式化定义)
    - [定义 1.2 (云原生架构的自适应控制系统)](#定义-12-云原生架构的自适应控制系统)
    - [定义 2.1 (容器映像的不可变性公理)](#定义-21-容器映像的不可变性公理)
    - [定义 3.1 (声明式API的规范-实现一致性)](#定义-31-声明式api的规范-实现一致性)
    - [定义 4.1 (服务网格的流量矩阵)](#定义-41-服务网格的流量矩阵)
  - [2025 对齐](#2025-对齐)
