...
[返回主题树](../00-主题树与内容索引.md) | [主计划文档](../00-形式化架构理论统一计划.md) | [相关计划](../13-项目报告与总结/README.md) | [返回上级](../README.md)
...
- [06-软件架构理论体系-设计模式理论](#06-软件架构理论体系-设计模式理论)
  ...
  - [形式化定义](#形式化定义)
    - [定义 3.2 (设计模式的重写系统)](#定义-32-设计模式的重写系统)
    - [定义 4.1.1 (单例模式的唯一性公理)](#定义-411-单例模式的唯一性公理)
    - [定义 4.1.2 (工厂模式的类型构造子)](#定义-412-工厂模式的类型构造子)
    - [定义 5.1 (结构型模式的组合代数)](#定义-51-结构型模式的组合代数)
  - [2025 对齐](#2025-对齐)
...
- [设计模式理论](03-设计模式理论.md)（本文档）
- [架构模式理论](01-架构模式理论.md)
- [分布式系统理论](../07-分布式与微服务/01-分布式系统理论.md)

### 2.2 相关文件

- [00-软件架构理论体系总论](00-软件架构理论体系总论.md)
