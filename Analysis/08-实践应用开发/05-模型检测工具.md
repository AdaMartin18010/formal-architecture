...
- **国际 Wiki**：
  - [Wikipedia: 模型检测工具](https://en.wikipedia.org/wiki/模型检测工具)
  - [nLab: 模型检测工具](https://ncatlab.org/nlab/show/模型检测工具)
  - [Stanford Encyclopedia: 模型检测工具](https://plato.stanford.edu/entries/模型检测工具/)

- **名校课程**：
  - [MIT: 模型检测工具](https://ocw.mit.edu/courses/)
  - [Stanford: 模型检测工具](https://web.stanford.edu/class/)
  - [CMU: 模型检测工具](https://www.cs.cmu.edu/~模型检测工具/)
