...
- [Formal_Language_Theory_Comprehensive_Deepening.md](../03-形式语言理论体系/00-形式语言理论统一总论.md)

### 2.2 相关文件

- [Automata_Theory.md](../06-形式模型理论体系/05-自动机理论.md)
...
- **名校课程**：
  - [CMU 15-453: Formal Languages, Automata and Computability](https://www.cs.cmu.edu/~15453/)（形式语言）
  - [MIT 18.404: Theory of Computation](https://ocw.mit.edu/courses/18-404-theory-of-computation-fall-2020/)（计算理论）
  - [Stanford CS 154: Introduction to Automata and Complexity Theory](https://web.stanford.edu/class/cs154/)（自动机理论）
...
- **代表性论文**：
  ...
  - [Formal Languages and Their Relation to Automata](https://www.elsevier.com/books/formal-languages-and-their-relation-to-automata/lewis/978-0-201-02988-8) (Lewis & Papadimitriou, 1998)
  - [Elements of the Theory of Computation](https://www.pearson.com/us/higher-education/program/Lewis-Elements-of-the-Theory-of-Computation-2nd-Edition/PGM33482.html) (Lewis & Papadimitriou, 1997)

- **前沿技术**：
  - [ANTLR](https://www.antlr.org/)（解析器生成器）
  - [Lex & Yacc](https://www.oreilly.com/library/view/lex-yacc/9781565920002/)（词法分析器生成器）
  - [Bison](https://www.gnu.org/software/bison/)（GNU解析器生成器）
  - [Ragel](http://www.colm.net/open-source/ragel/)（状态机编译器）
