...
- [Linear_Affine_Temporal_Type_Theory_Comprehensive.md](../02-数学理论体系/08-类型论基础.md)

### 2.2 相关文件

- [Advanced_Type_Theory_Comprehensive_Deepening.md](../02-数学理论体系/08-类型论基础.md)
- [Linear_Type_Theory.md](../02-数学理论体系/08-类型论基础.md)
- [Affine_Type_Theory.md](../02-数学理论体系/08-类型论基础.md)
...
- **名校课程**：
  - [CMU 15-312: Foundations of Programming Languages](https://www.cs.cmu.edu/~rwh/courses/ppl/)（线性逻辑与类型）
  - [MIT 18.510: Introduction to Mathematical Logic](https://ocw.mit.edu/courses/18-510-introduction-to-mathematical-logic-fall-2020/)（逻辑系统）
  - [Stanford CS 242: Programming Languages](https://web.stanford.edu/class/cs242/)（类型系统）

- **代表性论文**：
  - [Linear Logic](https://www.sciencedirect.com/science/article/pii/0304397587900454) (Girard, 1987)
  - [A Linear/Modal Calculus](https://link.springer.com/chapter/10.1007/3-540-58027-1_18) (Benton et al., 1993)
...
- **前沿技术**：
  ...
  - [Rust](https://www.rust-lang.org/)（线性类型系统实践）
