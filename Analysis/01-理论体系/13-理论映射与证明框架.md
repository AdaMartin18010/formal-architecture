...
- [01-理论体系-理论映射与证明框架](#01-理论体系-理论映射与证明框架)
  ...
  - [形式化定义](#形式化定义)
    - [定义 2.1 (理论映射函子)](#定义-21-理论映射函子)
    - [定义 7.1 (映射正确性)](#定义-71-映射正确性)
    - [定义 8.1 (行为双模拟)](#定义-81-行为双模拟)
  - [2025 对齐](#2025-对齐)
...
- [01-理论体系总论.md](../00-理论体系总论.md)：理论体系全局导航
...
- **前沿技术**：
  ...
  - [Agda](https://wiki.portal.chalmers.se/agda/pmwiki.php)（依赖类型证明）
