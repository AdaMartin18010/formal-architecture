...
- [Temporal_Logic_Control_Comprehensive_Deepening.md](../06-形式模型理论体系/03-时序逻辑理论.md)

### 2.2 相关文件

- [Advanced_Temporal_Logic_Control_Comprehensive.md](../06-形式模型理论体系/03-时序逻辑理论.md)
- [Advanced_Temporal_Logic_Control_Extended.md](../06-形式模型理论体系/03-时序逻辑理论.md)
- [Control_Theory_Temporal_Logic_Comprehensive_v3.md](../06-形式模型理论体系/03-时序逻辑理论.md)
- [Advanced_Control_Theory_Temporal_Logic_v4.md](../06-形式模型理论体系/03-时序逻辑理论.md)
- [Temporal_Logic_Control.md](../06-形式模型理论体系/03-时序逻辑理论.md)
- [控制论理论.md](../06-形式模型理论体系/03-时序逻辑理论.md)
...
- **名校课程**：
  - [CMU 15-312: Foundations of Programming Languages](https://www.cs.cmu.edu/~rwh/courses/ppl/)（时序逻辑）
...
- **代表性论文**：
  ...
  - [Temporal Verification of Reactive Systems: Safety](https://link.springer.com/book/10.1007/978-1-4612-4222-2) (Manna & Pnueli, 1995)

- **前沿技术**：
  - [TLA+](https://lamport.azurewebsites.net/tla/tla.html)（时序逻辑规范语言）
