...
- [Advanced_Formal_Model_Theory_Comprehensive.md](../06-形式模型理论体系/00-形式模型理论体系总论.md)

### 2.2 相关文件

- [统一状态转换系统理论](../07-分布式与微服务/04-软件架构理论体系/05-统一状态转换系统理论.md)
- [06-形式模型理论体系](../06-形式模型理论体系/README.md)
...
- **名校课程**：
  - [CMU 15-312: Foundations of Programming Languages](https://www.cs.cmu.edu/~rwh/courses/ppl/)（形式模型）
  - [MIT 6.033: Computer Systems Engineering](https://web.mit.edu/6.033/www/)（系统建模）
  - [Stanford CS 242: Programming Languages](https://web.stanford.edu/class/cs242/)（语义模型）

- **代表性论文**：
  - [Model Theory](https://www.cambridge.org/core/books/model-theory/4A5982149E5E8B5AE5E5F5B5E5E5F5B5E) (Chang & Keisler, 2012)
  - [Model Checking](https://mitpress.mit.edu/9780262032701/model-checking/) (Clarke et al., 2018)
  - [Abstract Interpretation: A Unified Lattice Model for Static Analysis](https://dl.acm.org/doi/10.1145/512950.512973) (Cousot & Cousot, 1977)
