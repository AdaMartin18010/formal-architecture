...
- [Advanced_Control_Theory_Extended.md](../07-理论统一与整合/00-理论统一与整合总论.md)
- [Advanced_Control_Theory_Synthesis_Extended.md](../07-理论统一与整合/00-理论统一与整合总论.md)
...
- **名校课程**：
  ...
  - [MIT 6.170: Software Studio](https://web.mit.edu/6.170/www/)（软件开发）
  - [Stanford CS 108: Object-Oriented System Design](https://web.stanford.edu/class/cs108/)（系统设计）
...
- **前沿技术**：
  ...
  - [CI/CD](https://www.atlassian.com/continuous-delivery/principles/continuous-integration-vs-delivery-vs-deployment)（持续集成/部署）
