...
- **国际 Wiki**：
  - [Wikipedia: Terminology](https://en.wikipedia.org/wiki/Terminology)
  - [Wikipedia: Glossary](https://en.wikipedia.org/wiki/Glossary)
  - [Wikipedia: Ontology (information science)](https://en.wikipedia.org/wiki/Ontology_(information_science))
  - [Wikipedia: Controlled vocabulary](https://en.wikipedia.org/wiki/Controlled_vocabulary)

- **名校课程**：
  - [CMU 15-312: Foundations of Programming Languages](https://www.cs.cmu.edu/~rwh/courses/ppl/)（形式化定义）
  - [MIT 6.033: Computer Systems Engineering](https://web.mit.edu/6.033/www/)（系统规范）
  - [Stanford CS 242: Programming Languages](https://web.stanford.edu/class/cs242/)（语言定义）
...
- **代表性论文**：
  ...
  - [OWL Web Ontology Language](https://www.w3.org/TR/owl2-overview/) (W3C, 2012)
