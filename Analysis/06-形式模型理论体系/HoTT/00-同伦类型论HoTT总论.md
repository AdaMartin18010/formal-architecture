...
- [同伦类型论 HoTT 总论](#同伦类型论-hott-总论)
  - [目录](#目录)
  - [1. 概述](#1-概述)
    - [1.1 同伦类型论定位](#11-同伦类型论定位)
    - [1.2 核心思想](#12-核心思想)
    - [1.3 与形式化架构的关系](#13-与形式化架构的关系)
  - [2. 单值公理与恒等类型](#2-单值公理与恒等类型)
    - [2.1 恒等类型](#21-恒等类型)
    - [2.2 单值公理（Univalence Axiom）](#22-单值公理univalence-axiom)
    - [2.3 与形式化验证](#23-与形式化验证)
  - [3. 高阶归纳类型](#3-高阶归纳类型)
    - [3.1 归纳类型扩展](#31-归纳类型扩展)
    - [3.2 典型 HIT](#32-典型-hit)
    - [3.3 与形式模型](#33-与形式模型)
  - [4. 与项目理论映射](#4-与项目理论映射)
  - [5. 课程对齐](#5-课程对齐)
    - [5.1 Cambridge L313](#51-cambridge-l313)
    - [5.2 CMU 80-518/818](#52-cmu-80-518818)
    - [5.3 数学权威教育交叉引用](#53-数学权威教育交叉引用)
    - [5.4 其他资源](#54-其他资源)
  - [2025 对齐](#2025-对齐)
