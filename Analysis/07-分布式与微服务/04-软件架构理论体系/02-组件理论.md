...
- **国际 Wiki**：
  ...
  - [Wikipedia: Component model](https://en.wikipedia.org/wiki/Component_model)
  - [SEBoK: Component-Based Architecture](https://sebokwiki.org/wiki/Component-Based_Architecture)

- **名校课程**：
  - [CMU 17-313: Foundations of Software Engineering](https://www.cs.cmu.edu/~ckaestne/17313/)（组件化开发）
  - [MIT 6.033: Computer Systems Engineering](https://web.mit.edu/6.033/www/)（系统组件设计）
  - [Stanford CS 244: Advanced Computer Systems](https://web.stanford.edu/class/cs244/)（分布式组件）
...
- **前沿技术**：
  ...
  - [Angular Components](https://angular.io/)（Angular组件框架）
