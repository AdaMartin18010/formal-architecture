...
- **国际 Wiki**：
  ...
  - [nLab: 软件架构理论统一总论](https://ncatlab.org/nlab/show/软件架构理论统一总论)
  - [Stanford Encyclopedia: 软件架构理论统一总论](https://plato.stanford.edu/entries/软件架构理论统一总论/)

- **名校课程**：
  - [MIT: 软件架构理论统一总论](https://ocw.mit.edu/courses/)
  - [Stanford: 软件架构理论统一总论](https://web.stanford.edu/class/)
  - [CMU: 软件架构理论统一总论](https://www.cs.cmu.edu/~软件架构理论统一总论/)
