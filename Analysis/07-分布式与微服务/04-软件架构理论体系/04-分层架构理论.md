...
- **国际 Wiki**：
  ...
  - [Wikipedia: Layered architecture](https://en.wikipedia.org/wiki/Layered_architecture)
  - [Wikipedia: Software architecture](https://en.wikipedia.org/wiki/Software_architecture)
  - [Wikipedia: N-tier architecture](https://en.wikipedia.org/wiki/Multitier_architecture)

- **名校课程**：
  - [CMU 17-313: Foundations of Software Engineering](https://www.cs.cmu.edu/~ckaestne/17313/)（分层架构实践）
  - [MIT 6.033: Computer Systems Engineering](https://web.mit.edu/6.033/www/)（系统分层设计）
  - [Stanford CS 244: Advanced Computer Systems](https://web.stanford.edu/class/cs244/)（分层架构）
...
- **前沿技术**：
  - [Spring Framework](https://spring.io/)（分层应用框架）
  - [ASP.NET Core](https://dotnet.microsoft.com/apps/aspnet)（分层Web框架）
  - [Django](https://www.djangoproject.com/)（Python分层框架）
  - [Express.js](https://expressjs.com/)（Node.js分层框架）
