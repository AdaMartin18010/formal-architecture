...
- **国际 Wiki**：
  - [Wikipedia: 分层架构理论](https://en.wikipedia.org/wiki/分层架构理论)
  - [nLab: 分层架构理论](https://ncatlab.org/nlab/show/分层架构理论)
  - [Stanford Encyclopedia: 分层架构理论](https://plato.stanford.edu/entries/分层架构理论/)

- **名校课程**：
  - [MIT: 分层架构理论](https://ocw.mit.edu/courses/)
  - [Stanford: 分层架构理论](https://web.stanford.edu/class/)
  - [CMU: 分层架构理论](https://www.cs.cmu.edu/~分层架构理论/)
