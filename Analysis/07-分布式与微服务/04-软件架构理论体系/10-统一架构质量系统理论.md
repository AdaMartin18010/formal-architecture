...
- **国际 Wiki**：
  ...
  - [SEBoK: Software Quality](https://sebokwiki.org/wiki/Software_Quality)

- **名校课程**：
  - [CMU 17-313: Foundations of Software Engineering](https://www.cs.cmu.edu/~ckaestne/17313/)（软件质量与架构）
  - [MIT 6.033: Computer Systems Engineering](https://web.mit.edu/6.033/www/)（系统质量保证）
  - [Stanford CS 244: Advanced Computer Systems](https://web.stanford.edu/class/cs244/)（架构质量评估）

- **代表性论文**：
  - [ISO/IEC 25010: Systems and software Quality Requirements and Evaluation](https://www.iso.org/standard/35733.html) (ISO Standard, 2011)
...
- **前沿技术**：
  - [SonarQube](https://www.sonarqube.org/)（代码质量分析平台）
