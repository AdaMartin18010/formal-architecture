...
- **国际 Wiki**：
  ...
  - [Wikipedia: Control system](https://en.wikipedia.org/wiki/Control_system)
  - [Wikipedia: Feedback](https://en.wikipedia.org/wiki/Feedback)
  - [Wikipedia: Cybernetics](https://en.wikipedia.org/wiki/Cybernetics)

- **名校课程**：
  - [MIT 6.302: Feedback Systems](https://ocw.mit.edu/courses/6-302-feedback-systems-spring-2007/)（反馈控制系统）
  - [Stanford EE 263: Introduction to Linear Dynamical Systems](https://web.stanford.edu/class/ee263/)（线性动态系统）
  - [CMU 16-311: Introduction to Robotics](https://www.cs.cmu.edu/~rasc/Download/AMRobots5.pdf)（机器人控制）

- **代表性论文**：
  - [Feedback Control of Computing Systems](https://ieeexplore.ieee.org/book/6267321) (Hellerstein et al., 2004)
  - [Control Theory for Software Systems](https://dl.acm.org/doi/10.1145/1095430.1081708) (ACM Computing Surveys, 2005)
  - [An Introduction to Control Theory](https://www.cds.caltech.edu/~murray/books/AM05/pdf/am08-complete_22Feb09.pdf) (Åström & Murray, 2008)

- **前沿技术**：
  - [Kubernetes HPA](https://kubernetes.io/docs/tasks/run-application/horizontal-pod-autoscale/)（水平自动扩展）
  - [Istio Traffic Management](https://istio.io/latest/docs/concepts/traffic-management/)（流量控制）
  - [Prometheus Alerting](https://prometheus.io/docs/alerting/latest/overview/)（监控告警）
  - [PID Controllers](https://en.wikipedia.org/wiki/PID_controller)（PID控制器）
