...
- [软件架构理论总论](00-软件架构理论统一总论.md)
- [编程语言理论](../../05-编程语言理论体系/00-编程语言理论统一总论.md)
- [形式语言理论](../../03-形式语言理论体系/00-形式语言理论统一总论.md)

### 8.2 实践应用

- [实践应用开发与工具](../../08-实践应用开发/README.md)
- [架构设计工具](../../08-实践应用开发/README.md)

## 9. 导航

- [返回软件架构理论总论](00-软件架构理论统一总论.md)
