...
- **国际 Wiki**：
  - [Wikipedia: 接口理论](https://en.wikipedia.org/wiki/接口理论)
  - [nLab: 接口理论](https://ncatlab.org/nlab/show/接口理论)
  - [Stanford Encyclopedia: 接口理论](https://plato.stanford.edu/entries/接口理论/)

- **名校课程**：
  - [MIT: 接口理论](https://ocw.mit.edu/courses/)
  - [Stanford: 接口理论](https://web.stanford.edu/class/)
  - [CMU: 接口理论](https://www.cs.cmu.edu/~接口理论/)
