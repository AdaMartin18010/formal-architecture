...
- **名校课程**：
  - [CMU 17-313: Foundations of Software Engineering](https://www.cs.cmu.edu/~ckaestne/17313/)（接口设计）
  - [MIT 6.033: Computer Systems Engineering](https://web.mit.edu/6.033/www/)（系统接口）
  - [Stanford CS 244: Advanced Computer Systems](https://web.stanford.edu/class/cs244/)（分布式接口）

- **代表性论文**：
  - [Design by Contract](https://www.eiffel.org/doc/eiffel/ET-_Design_by_Contract_%28tm%29%2C_Assertions_and_Exceptions) (Meyer, 1988)
  - [Interface Segregation Principle](https://en.wikipedia.org/wiki/Interface_segregation_principle) (SOLID Principles)
  - [REST: Architectural Styles and the Design of Network-based Software Architectures](https://www.ics.uci.edu/~fielding/pubs/dissertation/top.htm) (Fielding, 2000)

- **前沿技术**：
  - [OpenAPI Specification](https://www.openapis.org/)（API接口规范）
  - [gRPC](https://grpc.io/)（高性能RPC框架）
  - [GraphQL](https://graphql.org/)（查询语言和接口）
  - [REST API](https://restfulapi.net/)（RESTful接口设计）
