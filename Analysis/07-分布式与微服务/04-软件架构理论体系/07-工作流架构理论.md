...
- [工作流架构理论](#工作流架构理论)
  ...
  - [6. 导航](#6-导航)
  - [形式化定义](#形式化定义)
    - [定义 1.1 (工作流的形式化五元组)](#定义-11-工作流的形式化五元组)
    - [定义 2.1 (工作流网的 Petri 网结构)](#定义-21-工作流网的-petri-网结构)
    - [定义 2.2 (健全性的形式化)](#定义-22-健全性的形式化)
    - [定义 3.1 (工作流模式的组合语义)](#定义-31-工作流模式的组合语义)
  - [2025 对齐](#2025-对齐)
...
- **形式化基础**: [形式语言理论体系](../../03-形式语言理论体系/00-形式语言理论统一总论.md) (Petri网部分), [时序逻辑与模型检测](../../06-形式模型理论体系/03-时序逻辑理论.md)
