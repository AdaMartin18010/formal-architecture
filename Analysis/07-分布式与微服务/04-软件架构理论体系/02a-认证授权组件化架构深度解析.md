...
- **名校课程**：
  - [MIT 6.858: Computer Systems Security](https://css.csail.mit.edu/6.858/2022/)（系统安全与认证）
...
- **代表性论文**：
  - [OAuth 2.0 Authorization Framework](https://datatracker.ietf.org/doc/html/rfc6749) (RFC 6749, 2012)
  - [OpenID Connect Core 1.0](https://openid.net/specs/openid-connect-core-1_0.html) (OpenID Foundation, 2014)
  - [JWT: JSON Web Token](https://datatracker.ietf.org/doc/html/rfc7519) (RFC 7519, 2015)

- **前沿技术**：
  - [Keycloak](https://www.keycloak.org/)（身份和访问管理）
  - [Auth0](https://auth0.com/)（身份认证平台）
  - [Ory](https://www.ory.sh/)（身份基础设施）
  - [SPIFFE/SPIRE](https://spiffe.io/)（服务身份认证）
