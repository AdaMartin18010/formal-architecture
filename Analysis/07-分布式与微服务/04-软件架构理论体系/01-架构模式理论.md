...
- [架构模式理论-主题树形目录](#架构模式理论-主题树形目录)
  ...
  - [形式化定义](#形式化定义)
    - [定义 1.2 (架构模式的范畴论模型)](#定义-12-架构模式的范畴论模型)
    - [定义 2.1 (分层架构的序结构)](#定义-21-分层架构的序结构)
    - [定义 4.1 (微服务架构的服务图)](#定义-41-微服务架构的服务图)
  - [2025 对齐](#2025-对齐)
...
- [00-软件架构理论统一总论](00-软件架构理论统一总论.md)
- [03-设计模式理论](../03-设计模式理论.md)
- [01-分布式系统理论](../01-分布式系统理论.md)
- [05-微服务架构理论](../05-微服务架构理论.md)
- [06-云原生架构理论](../06-云原生架构理论.md)
- [07-事件驱动架构理论](../07-事件驱动架构理论.md)
- [08-服务网格架构理论](../08-服务网格架构理论.md)
- [00-主题树与内容索引](../../00-总览与导航/00-主题树与内容索引.md)
- [进度追踪与上下文](../../13-项目报告与总结/进度追踪与上下文.md)
