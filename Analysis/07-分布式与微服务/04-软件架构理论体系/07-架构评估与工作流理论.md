...
- [形式模型理论](../../06-形式模型理论体系/00-形式模型理论体系总论.md)

### 10.2 实践应用

- [架构设计工具](../../08-实践应用开发/03-自动化验证工具设计与实现.md)
- [模型检测工具](../../08-实践应用开发/03-自动化验证工具设计与实现.md)
...
- **名校课程**：
  - [CMU 17-313: Foundations of Software Engineering](https://www.cs.cmu.edu/~ckaestne/17313/)（架构评估与工作流）
  - [MIT 6.033: Computer Systems Engineering](https://web.mit.edu/6.033/www/)（系统架构评估）
  - [Stanford CS 244: Advanced Computer Systems](https://web.stanford.edu/class/cs244/)（工作流系统）
