...
- [06-软件架构理论体系-事件驱动架构理论](#06-软件架构理论体系-事件驱动架构理论)
  ...
  - [形式化定义](#形式化定义)
    - [定义 1.2 (事件驱动架构的发布-订阅演算)](#定义-12-事件驱动架构的发布-订阅演算)
    - [定义 2.1 (事件结构的因果偏序)](#定义-21-事件结构的因果偏序)
    - [定义 5.1 (事件溯源的状态函数)](#定义-51-事件溯源的状态函数)
    - [定义 5.2 (Saga的事务补偿代数)](#定义-52-saga的事务补偿代数)
  - [2025 对齐](#2025-对齐)
