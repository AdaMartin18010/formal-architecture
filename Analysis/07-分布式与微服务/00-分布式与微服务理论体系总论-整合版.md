...
| 课程/资源 | 链接/说明 | 与本体系对应 |
|-----------|-----------|--------------|
| MIT 6.824 分布式系统 | [pdos.csail.mit.edu/6.824](https://pdos.csail.mit.edu/6.824/) | 分布式系统语义 |
| MIT 6.033 计算机系统工程 | [web.mit.edu/6.033/www](https://web.mit.edu/6.033/www/) | 系统设计、分布式 |
| 2025 对齐资源库 | [2025-对齐资源库-最新版](../2025-对齐资源库-最新版.md) | 分布式/微服务课程 |
...
- **自检**：(1) 能说明一致性模型（强/最终）与形式验证的关系？(2) 能区分 06-软件架构 与 07/04-软件架构理论体系 的定位？详见 [核心概念表](../00-总览与导航/00-核心概念表（形式化架构）.md)、[推荐学习路径](../00-总览与导航/00-推荐学习路径.md)。
