...
- **国际 Wiki**：[Formal language](https://en.wikipedia.org/wiki/Formal_language)、[Automata theory](https://en.wikipedia.org/wiki/Automata_theory)、[Type theory](https://en.wikipedia.org/wiki/Type_theory)、[Lambda calculus](https://en.wikipedia.org/wiki/Lambda_calculus)
- **名校课程**：[CMU 15-312: Foundations of Programming Languages](https://www.cs.cmu.edu/~rwh/courses/ppl/)、[CMU 15-317: Constructive Logic](https://www.cs.cmu.edu/~fp/courses/15317-f09/)、[Berkeley CS 164: Programming Languages and Compilers](https://inst.eecs.berkeley.edu/~cs164/)、[MIT 6.820: Foundations of Program Analysis](https://6820-fa24.github.io/)
- **代表性论文**：POPL/PLDI/ICFP 近3年类型系统与效应系统综述
- **前沿技术**：[Wasm GC](https://v8.dev/blog/wasm-gc)、[Coq](https://coq.inria.fr/)、[Lean](https://lean-lang.org/)、[Agda](https://agda.readthedocs.io/)
- **对齐状态**：进行中（最后更新：2025-02-04）
...
- **名校课程**：[Stanford CS256: Formal Methods for Reactive Systems](https://cs256.stanford.edu/)（LTL/CTL、模型检测）、[Berkeley EECS 219C: Formal Methods](https://people.eecs.berkeley.edu/~sseshia/219c/)（SAT/SMT、综合）、[CMU 15-414: Bug Catching](https://www.cs.cmu.edu/~15414/s24/index.html)（Why3、演绎验证）
- **代表性论文**：CAV/TACAS/VMCAI 近3年综述与工具评测
- **前沿技术**：[TLA+](https://lamport.azurewebsites.net/tla/tla.html)、[TLA+ Wiki](https://docs.tlapl.us/)、[Apalache](https://apalache-mc.org/)、[UPPAAL](https://uppaal.org/)、[nuXmv](https://nuxmv.fbk.eu/)、[Coq](https://coq.inria.fr/)、[Lean](https://lean-lang.org/)
- **对齐状态**：进行中（最后更新：2025-02-04）
