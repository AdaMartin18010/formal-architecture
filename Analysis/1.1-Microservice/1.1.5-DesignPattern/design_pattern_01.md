...
- [1.1.5.1 微服务架构设计模式综述](#1151-微服务架构设计模式综述)
  ...
  - [1.1.5.1.2 设计模式分类](#11512-设计模式分类)
    - [1.1.5.1.2.1 按目的分类](#115121-按目的分类)
    - [1.1.5.1.2.2 微服务特有模式](#115122-微服务特有模式)
  - [1.1.5.1.3 典型模式详解](#11513-典型模式详解)
    - [1.1.5.1.3.1 断路器模式](#115131-断路器模式)
    - [1.1.5.1.3.2 Saga模式](#115132-saga模式)
    - [1.1.5.1.3.3 CQRS模式](#115133-cqrs模式)
  - [1.1.5.1.4 Rust/Haskell/Go代码示例](#11514-rusthaskellgo代码示例)
    - [1.1.5.1.4.1 Rust实现](#115141-rust实现)
    - [1.1.5.1.4.2 Haskell实现](#115142-haskell实现)
    - [1.1.5.1.4.3 Go实现](#115143-go实现)
  - [1.1.5.1.5 图表与形式化分析](#11515-图表与形式化分析)
    - [1.1.5.1.5.1 设计模式关系图](#115151-设计模式关系图)
    - [1.1.5.1.5.2 微服务架构模式](#115152-微服务架构模式)
    - [1.1.5.1.5.3 性能分析](#115153-性能分析)
